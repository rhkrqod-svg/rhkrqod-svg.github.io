...
const monsterTypes = [
  {
    ...
    name: "쩍벌남",
    shortName: "쩍벌남",
    image: "/assets/monsters/spread-seat-guy.png",
    color: "#7b2cbf",
    trim: "#c77dff",
    hp: 160,
    speed: 45,
  ...
  },
  {
    ...
    name: "통화녀",
    shortName: "통화녀",
    image: "/assets/monsters/phone-woman.png",
    color: "#00a896",
    trim: "#80ffdb",
    hp: 80,
    speed: 80,
  ...
  },
  {
    ...
    name: "밀치기아줌마",
    shortName: "밀치기",
    image: "/assets/monsters/pushy-aunt.png",
    color: "#f77f00",
    trim: "#ffbe0b",
    hp: 120,
    speed: 105,
  ...
  },
  {
    ...
    name: "철벽남",
    shortName: "철벽남",
    image: "/assets/monsters/wall-man.png",
    color: "#1d3557",
    trim: "#48cae4",
    hp: 220,
    speed: 30,
  ...
  },
  {
    ...
    name: "백팩 스핀러",
    shortName: "백팩",
    image: "/assets/monsters/backpack-spinner.png",
    color: "#2d6a4f",
    trim: "#95d5b2",
    hp: 110,
    speed: 90,
  ...
  },
  {
    ...
    name: "스피커폰맨",
    shortName: "스피커",
    image: "/assets/monsters/speakerphone-man.png",
    color: "#c9184a",
    trim: "#ff8fab",
    hp: 140,
    speed: 60,
...
function updateBlade() {
  if (weapons.strapOrbit.level > 0) {
    ...
    const strapRadius = 82 + weapons.strapOrbit.level * 8;
...
function drawBlades() {
  if (weapons.strapOrbit.level > 0) {
    ...
    ctx.beginPath();
    ctx.arc(center.x, center.y, strapRadius, 0, TAU);
    ctx.stroke();
    for (let i = 0; i < strapCount; i += 1) {
      const strapAngle = weapons.strapOrbit.angle + (TAU * i) / strapCount;
